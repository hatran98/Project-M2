  ...
  return (
    <div className="jordan">
      ...
      <span className="jordan-desc">
        Jordan and Paris Saint-Germain, a new set of colors and inspiration from the 1990s
        The area takes its collaborations to the next level with a remarkable motif.
      </span>
